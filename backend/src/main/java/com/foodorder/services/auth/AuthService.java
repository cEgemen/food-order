...
public class AuthService implements IAuthService {
    ...
    public Map<String,?> login(UserLogin user) {
        ...
        User authUser = ((UserPrinciple)authentication.getPrincipal()).getUser();
        String jwtToken = jwtService.generateJWT(user.getEmail());
        return Map.of("message","login is succesful","token",jwtToken,"username",authUser.getUsername(),"role",authUser.getRole(),"id",authUser.getId());
    }
