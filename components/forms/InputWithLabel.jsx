...
const InputWithLabel = ({label="",placeholder="",value="",onChange=(text) => {},containerStyle={},labelStyle={},inputStyle={},keyboardType="default",errors=[]}) => {

  return (
     <View style={[styles.inputWrapper,containerStyle]}>
                <Text style={[styles.inputLabel,labelStyle]}>{label}</Text>
                <TextInput style={[styles.input,inputStyle,{borderColor:errors.length !== 0 ? "red" : colors.dark_gray , borderWidth:errors.length !== 0 ? 1 : 0}]} keyboardType={keyboardType} placeholder={placeholder} value={value}  onChangeText={text => onChange(text) }  />  
                {
                 errors.length > 0 ? 
